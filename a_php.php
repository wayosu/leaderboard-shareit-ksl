...
if (isset($_POST['id_peserta']) && isset($_POST['ph'])) {
    $id_peserta = $_POST['id_peserta'];
    $point1 = $_POST['point1'];
    $point2 = $_POST['point2'];

    $sql = $mysqli->query("UPDATE php SET point1='$point1',point2='$point2' WHERE id_peserta='$id_peserta'");

    header('Location: a_php.php');
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <section class="mt-3">
        <div class="container">
            ...
            <div class="row justify-content-center mt-3">
                <h2 id="usage"><i class="nes-icon trophy"></i> PHP Assesment</h2>
                <h4 class="nes-text is-error">*Read first</h4>
                <p>1. <span class="nes-text">Point kuning</span> = Data Type</p>
                <p>2. <span class="nes-text">Point hijau</span> = Success Process</p>
                <div class="col">
                    <div class="nes-table-responsive">
                        <table class="nes-table is-bordered" width="99%">
                            ...
                            <tbody>
                                <?php
                                $result = $mysqli->query("SELECT *, ph.point1 + ph.point2 AS total FROM peserta p JOIN php ph ON p.id = ph.id_peserta ORDER BY total DESC");
                                $no = 1;
                                ...
                                ?>
                                    <form action="" method="POST">
                                        <div class="text-center">
                                            ...
                                            <input type="hidden" name="ph" value="php">
